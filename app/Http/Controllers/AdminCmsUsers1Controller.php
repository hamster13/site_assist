<?php namespace App\Http\Controllers;
	...
	class AdminCmsUsers1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Departemen","name"=>"departemen","join"=>"tbl_departemen,nama_dept"];
			$this->col[] = ["label"=>"Jabatan","name"=>"jabatan","join"=>"tbl_jabatan,nama_jab"];
			...
			$this->form[] = ['label'=>'Departemen','name'=>'departemen','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'tbl_departemen,nama_dept'];
			$this->form[] = ['label'=>'Jabatan','name'=>'jabatan','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'tbl_jabatan,nama_jab'];
			$this->form[] = ['label'=>'Gol','name'=>'gol','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','dataenum'=>'1;2;3;4'];
			...
			//$this->form[] = ['label'=>'Status','name'=>'status','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Departemen','name'=>'departemen','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'tbl_departemen,nama_dept'];
			//$this->form[] = ['label'=>'Jabatan','name'=>'jabatan','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Gol','name'=>'gol','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','dataenum'=>'1;2;3;4'];
			# OLD END FORM
